...
def valid(model, device, dataset, view, data_size, class_num, eval_h=False):
    ...
    total_pred, pred_vectors, high_level_vectors, labels_vector, low_level_vectors = inference(test_loader, model,
                                                                                               device, view, data_size)
    print("label shape", labels_vector.shape, total_pred.shape)
